...
public class FLTRAlg {
    ...
    public static void main(String args[]){
        ...
        FLTRAlg ftrl = new FLTRAlg(100000);

        String dir = "E:\\workspace\\kaggle\\CTR-avazu\\data\\";
        String trPath = dir + "train.csv";
        String tePath = dir + "test.csv";
        String submissionPath = dir + "submission.csv";
