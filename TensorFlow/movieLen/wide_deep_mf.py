...
data_dir = "E:/workspace/kaggle/ml-1m/"
...
def look_data():
    ...
    users = pd.read_table(user_file, sep='::', header=None, names=users_title, engine='python')
    print(users.head())

    movies_title = ['MovieID', 'Title', 'Genres']
    movies = pd.read_table(movies_file, sep='::', header=None, names=movies_title, engine='python')
    print(movies.head())
...
def load_data():
    ...
    ratings = pd.read_table(ratings_file, sep='::', header=None, names=ratings_title, engine='python')
